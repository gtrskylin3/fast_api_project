...
static_auth_token_to_username = {
    "f4a9e60ec99fadda15b042725067": "admin",
    "c9359cd06c3ce896cdb1eaef958aa013e0a0": "john",
}


def get_username_by_static_auth_token(
    auth_token: str = Header(alias="XXX-TOKEN-XXX"),
) -> str:
...
def demo_auth_logout_cookie(
    ...
    username = user_session_data["username"]
    return {"message": f"Buy, {username}", **user_session_data}
